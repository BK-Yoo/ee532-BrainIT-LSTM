...
def train_regression(x_train, y_train, x_test, y_test, data_file_path, file_attribute):
    ...
    for axis_index in range(0, 3):
        ...
        prediction = utils.predict_multi_step_ahead(regr_model, x_test[axis_index], md.delay_step)
